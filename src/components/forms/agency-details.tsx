...
export const AgencyDetails = ({ data }: Props) => {
    ...
    toast({
        variant: 'destructive',
        title: 'Opps!',
        description: 'unable to create your agency',
    })
}
    }
    const handleDeleteAgency = async () => {
        ...
        //WIP: discountineu the subscription
        try {
            ...
            console.log(error)
                toast({
                    variant: 'destructive',
                    title: 'Oops!',
                    description: 'unable to delete your agency',
                })
        }
            ...
            <CardContent>
                ...
                <FormField
                    ...
                    {data?.id && (
                        ...
                        <FormDescription>
                        ✨ Create a goal for your agency. As your business grows you goals grow too so don't forget to set the bar higher! </FormDescription>
                        <NumberInput
