  ...
  return (
    <>
      <section className="h-full w-full md:pt-44 mt-[-70px] relative flex items-center justify-center flex-col">
        ...
        <div className='flex justify-cneter items-center relative md:mt-[-70px]'>
      ...
      <section className='flex justify-center flex-col items-center gap-4 md:!mt-20 mt-[-60px]'>
        ...
        <div className='flex justify-center gap-4 flex-wrap mt-6'>
          ...
          <Card key={card.title} className={clsx('w-[300px] flex flex-col justify-between',{"border-2 border-primary":card.title==='Unlimited Sass'})}>
            <CardHeader>
            ...
            <CardContent>
              ...
              <span className='text-muted-forground'>/m</span>
            </CardContent>
